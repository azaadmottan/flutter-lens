...
History uses FlutterLens' default local storage.

To try it in a host application:

1. Create an app with `flutter create flutter_lens_demo`.
2. In that app's `pubspec.yaml`, add `flutter_lens` as a path dependency pointing
...
your real client and endpoint when integrating FlutterLens into your own app.
